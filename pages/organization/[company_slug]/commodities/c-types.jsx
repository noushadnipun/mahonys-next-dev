...
const Ctypes = () =>{
    ...
    const handleSave = async (e) => {
        ...
        let route = editData ? '/commodity-type/update' : '/commodity-type/create'
    ...
    return (
        <>
            ...
            <section className="row">
                <h3 className="page-headline">{total || 'List of '} Types of Commodity</h3>
...
const fetchData  = async (filter = {}) => {
    let route = '/commodity-type/index';
...
const Lists = ({datas, onEditItem}) => {
    ...
    return (
        <>
            <Table props={{
                tableHeads: ["Name", "Description", "Action"],
                tableBody: tableBody() ?? []
            }} />
        </>
    )
    ...
    return (
        <>
            <Bmodal modalShow={modalShow} modalHide={modalHide} modalHeader={modalHeader}
                ...
                <TextInput
                    props={{ label: "Name", type: "text", name: "name", value: data?.name }}
                />
